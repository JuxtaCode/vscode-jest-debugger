...
- simplyfied yarn pnp implementation, removed jestdebugger.detectYarnPnpJestBin config option
...
- Add ability to add CLI Options to run Jest command with jestdebugger.runOptions
...
- Deprecated `jestdebugger.runOptions` option in favor of `jestdebugger.debugOptions`.
